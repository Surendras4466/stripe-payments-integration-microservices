package com.myproject.payments.cache;
...
import com.myproject.payments.repository.interfaces.ValidationRulesParamsRepository;
import com.myproject.payments.repository.interfaces.ValidationRulesRepository;
...
public class ValidatorRuleCache {
	...
	public Map<String, String> getValidatorParamsForRule1(String ruleName) {
